...
print("4. Четные числа из списка целых чисел:", even_numbers)
...
print("5. Нечетные числа из списка целых чисел:", odd_numbers)

# 6. Написать скрипт который из списка целых чисел выведет чётные числа которые делятся на 5 без остатка.
even_dev_5 = list()
for i in numbers_list:
    if i % 2 == 0 and i % 5 == 0:
        even_dev_5.append(numbers_list[i])
print("6. Четные числа из списка целых чисел, которые делятся на 5:", even_dev_5)

# 7. Написать скрипт который из списка целых чисел выведет количество чётных чисел которые делятся на 5 без остатка.
print("Количество четных чисел из списка, которые делятся на 5:", len(even_dev_5))

# 8. Написать скрипт который создаст список целых рандомных чисел.
rand_list = []
rand = random.randint(0,70)
for i in range(rand):
    d_int = random.randint(0,70)
    rand_list.append(d_int)
    # print("d_int", d_int)
print("8. Список целых рандомных чисел:", rand_list)
